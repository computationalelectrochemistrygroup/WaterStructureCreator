...
from .modified_pymatgen.substrate_analyzer_mod import ZSLGenerator_mod, reduce_vectors
from .modified_pymatgen.interface_mod import InterfaceBuilder_mod
from .get_isotropic_supercell import get_maximally_isotropic_cell
from .plot_lattices import plot_matrices
from .create_slabs import export_structure, create_onesided_analysestruct, get_symmtrafo
...
def get_isotropic_SS(prim_slab_small, allSSmatrices, target_N):
    ...
    allmatrices_2Dsorted = get_maximally_isotropic_cell(newred, method='PCA')
